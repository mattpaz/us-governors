...
function buildPopState() {
  ...
  if (parties.length > 0 || genders.length > 0 || ethnicities.length > 0 || religions.length > 0 || lgbtq.length > 0 || search.length > 0) {
    url = '?filtered=true';
  }
 ...
 */
function init() {
  $.getJSON('us-governors/data/us-governors.json', function( data ) {
    ...
    $.each( data, function( key, val ) {
      if (!val.vacant) {
        ...
        var html = '<div class="governor mdl-card mdl-shadow--2dp card-square fade-in c' + key + '" onclick="void(0)" data-name="' + val.name + '" data-party="' + val.party + '" data-gender="' + val.gender + '" data-lgbtq="' + val.openley_lgbtq + '" data-ethnicity="' + val.ethnicity + '" data-title="' + val.title + '" data-religion="' + val.religion + '" data-state-name="' + val.state_name + '">' +
          '<div class="mdl-card__title mdl-card--expand lazy-load" data-bgsrc="us-governors/images/headshots/512x512/' + val.name_slug + '.jpg">' +
        ...
        jsonld.jobTitle = toTitleCase(val.title);
        ...
        $(html).appendTo('.governors .wrapper');
...
function doSearch(){
  ...
  if (search && search !== '') {
    $('.governor').hide();
    $('.governor[data-name*="' + search + '" i]').show();
    $('.governor[data-state-name*="' + search + '" i]').show();
    $('.governor[data-party*="' + search + '" i]').show();
  } else {
    $('.governor').show();
  }

  var count = $('.governor:visible').length;
  var total = $('.governor').length;
...
function updateRepresentatives () {
  // Handle Title
  var $governor = $('.governor[data-title="governor"]');
  var $senate_majority_leader = $('.governor[data-title="senate_majority_leader"]');
  var $senate_majority_whip = $('.governor[data-title="senate_majority_whip"]');
  var $senate_minority_leader = $('.governor[data-title="senate_minority_leader"]');
  var $senate_minority_whip = $('.governor[data-title="senate_minority_whip"]');

  var governor = $('#title-governor').is(':checked');
  ...
  if($governor.length === 0) {
    $('#title-governor').closest('label').hide();
  }

  // Handle Party
  var $constitution = $('.governor[data-party="constitution"]');
  var $democrat = $('.governor[data-party="democrat"]');
  var $green = $('.governor[data-party="green"]');
  var $independent = $('.governor[data-party="independent"]');
  var $libertarian = $('.governor[data-party="libertarian"]');
  var $nonpartisan = $('.governor[data-party="nonpartisan"]');
  var $republican = $('.governor[data-party="republican"]');
  ...
  // Handle Gender
  var $female = $('.governor[data-gender="female"]');
  var $male = $('.governor[data-gender="male"]');
  var $unspecified_gender = $('.governor[data-gender="unspecified"]');
  ...
  // Handle Ethnicity
  var $african_american = $('.governor[data-ethnicity="african-american"]');
  var $asian_american = $('.governor[data-ethnicity="asian-american"]');
  var $hispanic_american = $('.governor[data-ethnicity="hispanic-american"]');
  var $middle_eastern_american = $('.governor[data-ethnicity="middle-eastern-american"]');
  var $multi_racial_american = $('.governor[data-ethnicity="multi-racial-american"]');
  var $native_american = $('.governor[data-ethnicity="native-american"]');
  var $pacific_islander = $('.governor[data-ethnicity="pacific-islander"]');
  var $white_american = $('.governor[data-ethnicity="white-american"]');
  var $unspecified = $('.governor[data-ethnicity="unspecified"]');
  ...
  // Handle Religion
  var $african_methodist = $('.governor[data-religion="african-methodist"]');
  var $anglican = $('.governor[data-religion="anglican"]');
  var $baptist = $('.governor[data-religion="baptist"]');
  var $buddhism = $('.governor[data-religion="buddhism"]');
  var $christian = $('.governor[data-religion="christian"]');
  var $christian_reformed = $('.governor[data-religion="christian-reformed"]');
  var $christian_scientist = $('.governor[data-religion="christian-scientist"]');
  var $church_of_christ = $('.governor[data-religion="church-of-christ"]');
  var $church_of_god = $('.governor[data-religion="church-of-god"]');
  var $congregationalist = $('.governor[data-religion="congregationalist"]');
  var $deist = $('.governor[data-religion="deist"]');
  var $eastern_orthodox = $('.governor[data-religion="eastern-orthodox"]');
  var $episcopalian = $('.governor[data-religion="episcopalian"]');
  var $evangelical = $('.governor[data-religion="evangelical"]');
  var $evangelical_lutheran = $('.governor[data-religion="evangelical-lutheran"]');
  var $hindu = $('.governor[data-religion="hindu"]');
  var $jewish = $('.governor[data-religion="jewish"]');
  var $jodo_shinshu_buddhist = $('.governor[data-religion="jodo-shinshu-buddhist"]');
  var $lutheran = $('.governor[data-religion="lutheran"]');
  var $methodist = $('.governor[data-religion="methodist"]');
  var $mormon = $('.governor[data-religion="mormon"]');
  var $muslim = $('.governor[data-religion="muslim"]');
  var $nazarene_christian = $('.governor[data-religion="nazarene-christian"]');
  var $pentecostal = $('.governor[data-religion="pentecostal"]');
  var $presbyterian = $('.governor[data-religion="presbyterian"]');
  var $protestant = $('.governor[data-religion="protestant"]');
  var $roman_catholic = $('.governor[data-religion="roman-catholic"]');
  var $seventh_day_adventist_church = $('.governor[data-religion="seventh-day-adventist-church"]');
  var $soka_gakkai_buddhist = $('.governor[data-religion="soka-gakkai-buddhist"]');
  var $southern_baptist = $('.governor[data-religion="southern-baptist"]');
  var $united_church_of_christ = $('.governor[data-religion="united-church-of-christ"]');
  var $united_methodist = $('.governor[data-religion="united-methodist"]');
  var $unitarian_universalist = $('.governor[data-religion="unitarian-universalist"]');
  var $unspecified_religion = $('.governor[data-religion="unspecified"]');
  ...
  // Handle LGTBQ
  var $lgbtq_no = $('.governor[data-lgbtq="no"]');
  var $lgbtq_lesbian = $('.governor[data-lgbtq="lesbian"]');
  var $lgbtq_gay = $('.governor[data-lgbtq="gay"]');
  var $lgbtq_bisexual = $('.governor[data-lgbtq="bisexual"]');
  var $lgbtq_transgender = $('.governor[data-lgbtq="transgender"]');
  var $lgbtq_queer = $('.governor[data-lgbtq="queer"]');
  ...
  if (governor || senate_majority_leader || senate_majority_whip || senate_minority_leader || senate_minority_whip) {
    if (!governor) {
      $governor.hide();
    }
