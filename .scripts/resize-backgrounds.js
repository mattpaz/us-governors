...
var image640x360 = 'us-governors/images/backgrounds/640x360/';
var image960x540 = 'us-governors/images/backgrounds/960x540/';
var image1280x720 = 'us-governors/images/backgrounds/1280x720/';
var image1920x1080 = 'us-governors/images/backgrounds/1920x1080/';

glob('source/us-governors.jpg', {}, function (er, files) {
  if (files.length === 0) {
    console.log('× No background images to convert');
  } else {
    for (var i = 0; i < files.length; i++) {
      var fullSizeImage = files[i];
      var fileName = 'us-governors.jpg';
